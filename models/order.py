...
class Order(models.Model):
    ...
    def create(self, vals):
        ...
        if (vals.get('discount_type') == 'point'):
            ...
            self.env['phone.point'].search([('customer.id', '=', vals.get('customer'))]).write({'point': point})

        vals['name'] = self.env['ir.sequence'].next_by_code('phone.order') or 'New'
